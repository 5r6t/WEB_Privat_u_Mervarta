...
proto.viewFullscreen = function() {
  ...
  document.body.classList.add('is-fullscreen'); // Add class to body
  this.focus();
};

proto.exitFullscreen = function() {
  this._changeFullscreen(false);
  document.body.classList.remove('is-fullscreen'); // Remove class from body
};
...
function enableCarouselFullscreenOnClick() {
  ...
  document.querySelectorAll('.carousel').forEach(carousel => {
    ...
    instance.on('staticClick', (event, pointer, cellElement) => {
      if (cellElement && typeof instance.viewFullscreen === 'function' && !instance.isFullscreen) {
